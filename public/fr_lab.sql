...
INSERT INTO `fr_lab_auth_group_access` VALUES (31, 32, 1564551053, 1564551053);
...
INSERT INTO `fr_lab_auth_rule` VALUES (46, 'header_index', '总览', 1, 1, '{status} === 1', 1, 1, 1564541376, 1533544652, '');
...
) ENGINE = InnoDB AUTO_INCREMENT = 13447 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of fr_lab_log
-- ----------------------------
INSERT INTO `fr_lab_log` VALUES (13444, 'admin', 'login', '2019-07-31 16:13:32', '');
INSERT INTO `fr_lab_log` VALUES (13445, 'admin', 'logout', '2019-07-31 16:17:06', '');
INSERT INTO `fr_lab_log` VALUES (13446, 'admin', 'login', '2019-07-31 16:17:11', '');
...
CREATE TABLE `fr_lab_user`  (
  ...
  `password_hash` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '密码hash',
...
-- ----------------------------
INSERT INTO `fr_lab_user` VALUES (1, '系统管理员', 'admin', '$argon2i$v=19$m=1024,t=2,p=2$amJUZ1U1c1ZkM3I3Rms0SA$ERWeJgRzH+u8mndlm9Mx4+MzdKpMIW6zU5XLFH6ITkY', 'admin@xxx.com', '13500000000', '系统管理员', '-', 1, 1564561152, 1521533170);
INSERT INTO `fr_lab_user` VALUES (29, '测试账号1', 'test1', '$argon2i$v=19$m=1024,t=2,p=2$amJUZ1U1c1ZkM3I3Rms0SA$ERWeJgRzH+u8mndlm9Mx4+MzdKpMIW6zU5XLFH6ITkY', 'test1@xxx.com', '18300000000', '测试组', '-', 1, 1564551119, 1521533170);
INSERT INTO `fr_lab_user` VALUES (30, '测试账号2', 'test2', '$argon2i$v=19$m=1024,t=2,p=2$amJUZ1U1c1ZkM3I3Rms0SA$ERWeJgRzH+u8mndlm9Mx4+MzdKpMIW6zU5XLFH6ITkY', 'test2@xxx.com', '13500000000', '测试组', '-', 0, 1564551124, 1521533170);
INSERT INTO `fr_lab_user` VALUES (31, '测试账号3', 'test3', '$argon2i$v=19$m=1024,t=2,p=2$amJUZ1U1c1ZkM3I3Rms0SA$ERWeJgRzH+u8mndlm9Mx4+MzdKpMIW6zU5XLFH6ITkY', 'test3@xxx.com', '18900000000', '测试组', '-', 1, 1564551128, 1521533170);
